        ...
        <div className="client__content">
          <div className="text-description">
            <p className="text-description__item">
              На фильм:{" "}
              <span className="text-value">{state[0].ticket_filmname}</span>
            </p>
            <p className="text-description__item">
              Места: <span className="text-value">{places}</span>
            </p>
            <p className="text-description__item">
              В зале:{" "}
              <span className="text-value">{state[0].ticket_hallname}</span>
            </p>
            <p className="text-description__item">
              Начало сеанса:{" "}
              <span className="text-value">{state[0].ticket_time}</span>
            </p>
            <p className="text-description__item">
              Стоимость: <span className="text-value">{price}</span> рубл
              {getEndOfWord(price, "рубл")}
            </p>
          </div>
